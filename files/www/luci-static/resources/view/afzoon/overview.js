...
var dictionary = {
	...
	fa: {
		title: 'افزون', subtitle: 'مدیریت حافظهٔ USB، سواپ پایدار و اکسترُوت', language: 'زبان', system: 'نمای کلی روتر', device: 'حافظهٔ USB متصل', none: 'هیچ حافظهٔ USB متصل نیست.', model: 'روتر', openwrt: 'اوپن‌ورت', arch: 'معماری پردازنده', flash: 'فلش داخلی', overlay: 'فضای فعال overlay', ram: 'رم', swap: 'سواپ', virtual: 'رم + سواپ', capacity: 'ظرفیت', brand: 'برند / مدل', filesystem: 'سیستم فایل', port: 'ارتباط USB', partitions: 'پارتیشن‌ها', plan: 'طرح‌بندی حافظه', swapEnable: 'ساخت سواپ پایدار', rootEnable: 'ساخت extroot پایدار', swapSize: 'سواپ (MiB)', rootSize: 'extroot (MiB)', available: 'فضای قابل استفاده پس از ذخیرهٔ ایمنی', suggestion: 'اندازهٔ پیشنهادی extroot', apply: 'اعمال تغییرات', safe: 'حذف امن', disable: 'غیرفعال‌سازی extroot (نیازمند ریبوت)', warning: 'با اعمال تغییرات، تمام پارتیشن‌ها و داده‌های فلش انتخاب‌شده برای همیشه پاک می‌شوند.', confirm: 'فلش انتخاب‌شده پاک و پیکربندی شود؟', reboot: 'extroot آماده شد. برای فعال‌شدن روتر را ریبوت کنید.', disabled: 'extroot برای بوت بعدی غیرفعال شد. پیش از جداکردن فلش، روتر را ریبوت کنید.', done: 'تغییرات اعمال شد.', removeWarning: 'حذف امن، سواپ فعال را متوقف و فلش را unmount می‌کند. extroot فعال ابتدا به ریبوت نیاز دارد.', error: 'عملیات ناموفق بود', refresh: 'نوسازی', mib: 'MiB'
	}
};
